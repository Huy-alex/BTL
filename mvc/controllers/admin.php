    ...
    class admin extends controller{
        ...
        function addproduct(){
            ...
            if(isset($_POST["submit"])){
                ...
                // if($product["price"] < 0){
                //     $notifi["price"] = "Vui long nhap gia lon hon 0";
                // }
                if($product["price"] == ""){
                ...
                if($notifi == null){
                    $result = $this->productmodel->AddProduct($product["name"],$product["price"],$img_product,$product["quantity"],$product["decs"],$product["id_category"],$name_category[0]["name"],$product["sale"]);
                    if($result == true){
